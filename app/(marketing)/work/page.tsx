      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            ...
            <GlassCard key={index} hover className="overflow-hidden p-0">
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute top-4 right-4">
                  <span className="px-3 py-1 glass-morphism-light rounded-full text-sm">
                    {project.category}
                  </span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="text-2xl font-bold mb-3 flex items-center">
                  {project.title}
                  <ExternalLink className="w-5 h-5 ml-2 text-accent-teal" />
                </h3>
                ...
                <div className="flex flex-wrap gap-2">
                  {project.metrics.map((metric, i) => (
                    <span
                      key={i}
                      className="px-3 py-1 bg-accent-teal/10 text-accent-teal rounded-lg text-sm"
                    >
                      {metric}
                    </span>
                  ))}
        ...
        >
          <GlassCard className="p-12">
            ...
            <a
              href="/contact"
              className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-accent-teal to-accent-blue text-white rounded-xl hover:shadow-lg hover:shadow-accent-teal/50 transition-all"
            >
              Get in Touch
            </a>
          </GlassCard>
